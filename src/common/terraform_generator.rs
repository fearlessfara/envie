...
# These locals are provided by Envie for your Terraform code
...
"#, project_name, environment_id, unit_name, project_name, environment_id, unit_name)
    ...
    pub fn generate_variables_file(
        ...
        content.push_str("# Auto-generated by Envie - DO NOT EDIT\n");
        content.push_str("# This file is automatically generated and will be overwritten\n");
        content.push_str("# These variables are populated by Envie during deployment\n\n");
    ...
    pub fn write_generated_files(
        ...
        // Generate locals file with Envie-provided values
        ...
        let backend_file = module_path.join("backend.envie.tf");
        std::fs::write(backend_file, backend_content)?;

        // Write remote state data sources file
        let remote_state_file = module_path.join("remote_state.envie.tf");
        std::fs::write(remote_state_file, remote_state_content)?;

        // Write locals file with Envie-provided values
        let locals_file = module_path.join("locals.envie.tf");
        std::fs::write(locals_file, locals_content)?;

        // Write variables file
        let variables_file = module_path.join("variables.envie.tf");
        std::fs::write(variables_file, variables_content)?;
